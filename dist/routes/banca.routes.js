...
router.get('/', authenticateToken, async (req, res) => {
    try {
        ...
        // Agrupar por bancaId
        const apostasPorBanca = new Map();
        const transacoesPorBanca = new Map();
...
router.get('/:id/compartilhar', authenticateToken, async (req, res) => {
    try {
        const { id } = req.params;
        const userId = req.userId;
        const banca = await prisma.bankroll.findFirst({
...
//# sourceMappingURL=banca.routes.js.map