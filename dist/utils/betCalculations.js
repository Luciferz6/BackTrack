 ...
 */
export function calcularResultadoAposta(status, valorApostado, retornoObtido) {
    switch (status) {
        case 'Ganha':
 ...
 */
export function isApostaConcluida(status) {
    return status !== 'Pendente';
}
/**
 * Verifica se uma aposta é considerada ganha para cálculo de win rate
 */
export function isApostaGanha(status) {
    return status === 'Ganha' || status === 'Meio Ganha';
}
//# sourceMappingURL=betCalculations.js.map